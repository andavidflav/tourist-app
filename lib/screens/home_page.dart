...
//Markers set
  ...
  final key = 'AIzaSyANnAW8cBckguU_nOK3YvuM_n8ZAJ31ngg';
...
//Initial map position on load
  ...
  void _setOriginToCurrentLocation() {
    if (_currentPosition != null) {
      final String latitude = _currentPosition!.latitude.toString();
      final String longitude = _currentPosition!.longitude.toString();
      _originController.text = '$latitude, $longitude';
    }
  }
  @override
          ...
          children: [
            Stack(
              children: [
                ...
                //
                //                       // Check if only one search result is returned and call getDirections
                //                       if (searchResults.length == 1) {
                //                         _destinationController.text = searchResults[0].description ?? '';
                //                         setState(() {
                //                           searchToggle = false;
                //                           searchController.text = '';
                //                           _markers = {};
                //                         });
                //                         getDirectionso(_originController.text, _destinationController.text);
                //                       }
                //                     } else {
                                ...
                                Padding(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      GestureDetector(
                                        onTap: () {
                                          double latitude =  tappedPlaceDetail['geometry']['location']['lat'];
                                          double longitude =  tappedPlaceDetail['geometry']['location']['lng'];


                                          Navigator.push(
                                            context,
                                            MaterialPageRoute(builder: (context) => DirMapView(
